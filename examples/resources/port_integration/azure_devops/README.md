# Azure DevOps integration example (Port PR #18246)

This example documents updated Azure DevOps integration mappings introduced in [port-labs/Port#18246](https://github.com/port-labs/Port/pull/18246).
...
| `test-run` | `project` relation strips spaces via `gsub(" "; "")` |
| `project` relations | Project IDs strip spaces via `gsub(" "; "")` on environment, test-run, and other resources |
