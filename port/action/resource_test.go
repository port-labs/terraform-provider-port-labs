		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr("port_action.action1", "user_properties.string_props.encryptedObjectProp.title", "Encrypted objectt"),
					resource.TestCheckResourceAttr("port_action.action1", "user_properties.string_props.encryptedObjectProp.required", "true"),
					resource.TestCheckResourceAttr("port_action.action1", "user_properties.string_props.encryptedObjectProp.encryption", "fernet"),
				),
			},
		},
	})
