...
func OrganizationSchema() map[string]schema.Attribute {
	return map[string]schema.Attribute{
		...
		"idle_time_ms": schema.Int64Attribute{
			MarkdownDescription: "The idle timeout in milliseconds for the organization. Must be at least 600000 (10 minutes) when set. Set to `null` to clear.",
			Optional:            true,
			Computed:            true,
			Validators: []validator.Int64{
				int64validator.AtLeast(600_000),
			},
		},
	}
}
